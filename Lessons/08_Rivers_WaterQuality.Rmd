...
# Only include time span that is relevant for water quality variables
...
# Combine water quality and flow data
...
# collapse to variable & value columns
...
# significant negative relationship, but explains very little of the data
plot(lm(data = NeuseWQFlow_processed, log10(FecalColiform_cfu.100mL) ~ log10(Flow_cfs)))
...
```{r}
ggplot(NeuseWQFlow_processed, aes(x=HydrologicCondition, 
                                  y=FecalColiform_cfu.100mL,
                                  color=HydrologicCondition)) +
